...
namespace projektowanie_oprogramowania_final_project.Controllers
{
    [AllowAnonymous]
    public class CinemasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CinemaId")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CinemaId")] Cinema cinema)
        {
